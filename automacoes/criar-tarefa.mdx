...
<Tip>
  Coloque o **nome do lead** e o **motivo** no título, usando variáveis: `Retornar para {{name}} — interessado em {{produto}}`. Quem abrir a tarefa entende o contexto na hora. Veja [Usar variáveis nas mensagens](/automacoes/variaveis).
</Tip>
