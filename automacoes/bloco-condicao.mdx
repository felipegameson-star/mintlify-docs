...
<Warning>
  O bloco Condição só compara os **campos fixos** do contato — nome, e-mail, telefone e notas. Ele **não** aceita campo personalizado nem mais de dois caminhos. Para isso, use o bloco [Switch](/automacoes/bloco-switch).
</Warning>
