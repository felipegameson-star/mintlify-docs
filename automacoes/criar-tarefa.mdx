...
<Warning>
  Evite criar a **mesma tarefa várias vezes** para o mesmo lead. Se a automação puder rodar de novo para o mesmo contato, considere aplicar uma tag de controle (ex.: `tarefa-criada`) e usar uma [Condição](/automacoes/introducao) para não duplicar.
</Warning>
